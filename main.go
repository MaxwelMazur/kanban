...
func (m *Model) initLists(width, height int) {
	...
	m.lists[todo].SetItems([]list.Item{
		Task{status: todo, title: "comprar", description: "6 ovos"},
		Task{status: todo, title: "comer", description: "ovos fitros"},
	})
	// Init in progress
	m.lists[inProgress].Title = "In Progress"
	m.lists[inProgress].SetItems([]list.Item{
		Task{status: todo, title: "escrever codigo", description: "sempre em golang ou lua é claro kkk"},
	})
	// Init done
	m.lists[done].Title = "Done"
	m.lists[done].SetItems([]list.Item{
		Task{status: todo, title: "cofé", description: "já tomei e quero mais"},
	})
}
